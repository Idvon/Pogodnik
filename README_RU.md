...
Для работы приложения необходим Python 3.13 или выше и poetry
...
Для работы Flask файл должен иметь название "c.json"

### **Запуск**  

Команды вводятся в консоли в той же директории, что и проект
...
Каждый релевантный результат записывается в db.sqlite3 и файл вывода (CSV) при `timeout` > время с прошлого запроса
...
- [x] Кеширование
- [x] Веб-интерфейс
- [x] Вывод прогноза погоды на весь день, неделю
- [ ] Docker контейнер